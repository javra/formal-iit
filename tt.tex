...
We will now show that indexed W-types live up to our expectations of capturing
all previously mentioned inductive types, from $\emptytype$ to $\vecty$.
To provide a succinct translation of all of these, we will provide all the
arguments for the respective indexed W-types in Table~\ref{tbl:tt-iw},
