...
the Favonia-Shulman result, \Cref{thm:favonia:SvK}.
...
(and to match \Cref{thm:favonia:SvK} more closely):
...
(\Cref{thm:hits-svk}) from the higher version (\Cref{thm:paths-higher-SvK}).
...
\begin{remark} \label{remark:generalized-squid}
\Cref{thm:higher-SvK} and its proof 
